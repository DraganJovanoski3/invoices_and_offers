<?php
/**
 * Fix Invoice Legal Fields - Simple Version
 * This script adds missing columns to invoices table
 */
...
try {
    ...
    echo "<h2>Adding Missing Columns to invoices Table</h2>";
    echo "<hr>";
    ...
    echo "<a href='invoices.php' style='padding: 10px 20px; background: #007bff; color: white; text-decoration: none; border-radius: 5px;'>Go to Invoices</a>";
